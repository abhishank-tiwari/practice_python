...
print("Original array a is (here copy command is not used) ","\n",a)
slicing = a[3:6]
...
print("Conclusion - in view changes also got reflected to original array from which slicing was performed ") 